...
const paths: Record<SocialKey, React.ReactNode> = {
  ...
  bugcrowd: (
    <path d="M12 2 3 6v6c0 5 3.84 8.74 9 10 5.16-1.26 9-5 9-10V6zm0 3.2 6 2.67V12c0 3.5-2.5 6.2-6 7.3-3.5-1.1-6-3.8-6-7.3V7.87zM12 8a2.4 2.4 0 100 4.8A2.4 2.4 0 0012 8zm-3.3 5.4a3.3 3.3 0 006.6 0z" />
  ),
  telegram: (
